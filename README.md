...
`mall-swarm`是一套微服务商城系统，采用了 Spring Cloud & Alibaba、Spring Boot
2.5.*、OAuth2、MyBatis、Elasticsearch、Docker、Kubernetes等核心技术，同时提供了基于Vue的管理后台方便快速搭建系统。
`mall-swarm`在电商业务的基础集成了注册中心、配置中心、监控中心、网关等系统功能。文档齐全，附带全套Spring Cloud教程。
...
| Redis           | 6.2.6    | https://www.redis.io/download                                    |
...
| Kibana          | 7.14.2   | https://www.elastic.co/cn/downloads/kibana                   |
| Logstash        | 7.14.2   | https://www.elastic.co/cn/downloads/logstash                 |
| MongoDb         | 5.0.3    | https://www.mongodb.com/download-center                      |
| RabbitMq        | 3.9.8    | http://www.rabbitmq.com/download.html                        |
| Nginx           | 1.10     | http://www.nginx.org/en/download.html                            |
| Nacos           | v2.0.3   | https://www.nacos.io/en-us/index.html                            |
