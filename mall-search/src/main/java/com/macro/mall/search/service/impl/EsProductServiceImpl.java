...
public class EsProductServiceImpl implements EsProductService {
    ...
    public Page<EsProduct> recommend(Long id, Integer pageNum, Integer pageSize) {
        ...
        if (esProductList.size() > 0) {
            ...
            filterFunctionBuilders
                    .add(new FunctionScoreQueryBuilder.FilterFunctionBuilder(QueryBuilders.matchQuery("productCategoryId", productCategoryId),
    ...
    private EsProductRelatedInfo convertProductRelatedInfo(SearchHits<EsProduct> response) {
        ...
        List<? extends Terms.Bucket> attrIds = ((ParsedLongTerms) ((ParsedFilter) ((ParsedNested) productAttrs).getAggregations().get("productAttrs"))
